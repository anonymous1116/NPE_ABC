...
#SBATCH --qos=normal
#SBATCH --array=1,2,3,6,7               # Create a job array with indices from 1 to 10
...
python NABC/NPSE_training_NABC.py --task "bernoulli_glm2" --seed $seeds --num_training 300000
