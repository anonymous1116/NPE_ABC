...
#SBATCH --qos=normal
#SBATCH --array=9               # Create a job array with indices from 1 to 10
...
python NABC/NPSE_training_NABC.py --task "slcp_summary_transform2" --seed $seeds --num_training 1500000
