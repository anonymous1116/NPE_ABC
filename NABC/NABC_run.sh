...
#SBATCH --qos=normal
#SBATCH --array=2,3,4,6,7,8,9               # Create a job array with indices from 1 to 10
...
python NABC/NPSE_training_NABC.py --task "my_twomoons" --seed $seeds --num_training 500000
