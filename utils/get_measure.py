...
#python utils/get_measure.py --task "my_five_twomoons_err90" --measure "c2st" --x0_ind 1 --seed 1 --post_n_samples 10000 --num_training 3000000 --cond_den "nsf" --method "NPE"