...
def main(args):
    ...
    for i in range(num_chunks + 1): 
        ...
        index_ABC = ABC_rej2(x0, X_chunk, args.tol*1000, device)
    ...
    new_tol = 1e-3
    index_WABC = TABC_rejection(x0, X_abc, new_tol, density_estimator_npe, Y_abc.size(1), device, num_samples=100)
    ...
    output_dir = f"../depot_hyun/hyun/NPE_ABC/flow_c2st_latent4/{args.task}_context_tmp/J_{int(args.num_training/1000)}K/{int(args.L/1_000_000)}M_eta{sci_str}"
