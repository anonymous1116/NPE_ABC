...
# experiment3: without resampling but with context.
def main(args):
    seed = args.seed
    ...
    output_dir = f"../depot_hyun/hyun/NPE_ABC/flow_c2st_results_exp3/{args.task}_context/J_{int(args.num_training/1000)}K/{int(args.L/1_000_000)}M_eta{sci_str}"
