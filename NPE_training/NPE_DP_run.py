...
def main(args):
    ...
    if args.task == "table_dp_22":
        ...
        inference = inference.append_simulations(theta[:,:48], X[:,:48])
    else:
...
def get_args():
    ...
    parser.add_argument('--task', type=str, default='twomoons', help='Simulation DP type: table_dp_22')
    ...
    parser.add_argument('--method', type=str, default='NPE', help='Method type: NPE, FMPE')
