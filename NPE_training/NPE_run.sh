...
#python NPE_training/NPE_DP_run.py --task "table_dp_66" --seed $seeds --num_training 2000000 --method "NPE"
python NPE_training/NPE_run.py --task "double_slcp_summary_transform2" --seed $seeds --num_training 1000000 --method "NPSE_vp"
...
#python utils/get_measure.py --task "my_five_twomoons" --measure "c2st" --x0_ind 1 --seed 1 --post_n_samples 10000 --num_training 10000
