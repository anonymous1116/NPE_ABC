...
#SBATCH --qos=normal
#SBATCH --array=7               # Create a job array with indices from 1 to 10
...
python NPE_training/FMPE_run_NABC.py --task "slcp_summary_transform2" --seed $seeds --num_training 50000
