...
#SBATCH --qos=normal
#SBATCH --array=1,7               # Create a job array with indices from 1 to 10
...
python NPE_training/NPE_DP_run.py --task "table_dp_66" --seed $seeds --num_training 500000 --method "NPE"
#python NPE_training/NPE_run.py --task "bernoulli_glm2" --seed $seeds --num_training 500000 --method "NPSE"
...
#python NPE_training/NPE_run.py --task "mog_10" --seed 1 --num_training 300000 --method "NPSE"
