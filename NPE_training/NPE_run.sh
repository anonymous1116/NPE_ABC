...
python NPE_training/NPE_run_embed.py --task "slcp_ditractors" --seed $seeds --cond_den "nsf" --num_training 3000000 --cdim 10
#python NPE_training/NPSE_run.py --task "slcp_distractors" --seed $seeds --num_training 3000000
