...
python NPE_training/NPE_run.py --task "double_slcp_summary_transform2" --seed $seeds --cond_den "nsf" --num_training 3000000
...
# python utils/get_measure.py --task "my_five_twomoons_err2" --measure "c2st" --x0_ind 1 --seed 1 --post_n_samples 10000 --num_training 10000
