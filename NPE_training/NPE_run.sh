...
#SBATCH --qos=normal
#SBATCH --array=1,3,4,7,9               # Create a job array with indices from 1 to 10
...
python NPE_training/FMPE_run_NABC.py --task "my_twomoons" --seed $seeds --num_training 1000000
