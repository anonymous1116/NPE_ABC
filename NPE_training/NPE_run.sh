...
#python NPE_training/NPE_DP_run.py --task "table_dp_66" --seed $seeds --num_training 100000 --method "NPE"
python NPE_training/NPE_run.py --task "double_slcp_summary_transform2" --seed $seeds --num_training 2000000 --method "NPSE_vp"
