...
python NPE_training/NPE_DP_run.py --task "table_dp_66" --seed $seeds --num_training 2000000 --method "FMPE"
#python NPE_training/NPE_run.py --task "my_twomoons" --seed $seeds --num_training 500000 --method "NPE"
