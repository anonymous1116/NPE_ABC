...
#SBATCH --qos=normal
#SBATCH --array=2,3,4,5,6,8               # Create a job array with indices from 1 to 10
...
python NPE_training/FMPE_run_NABC.py --task "mog_10_nabc" --seed $seeds --num_training 500000
