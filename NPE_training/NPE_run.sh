...
python NPE_training/NPE_run.py --task "slcp_summary_transform2" --seed $seeds --cond_den "nsf" --num_training 300000
#python NPE_training/NPE_run.py --task "slcp_summary_transform2" --seed 1 --num_training 10000 --cond_den "nsf"
