...
def main(args):
    ...
    output_dir = f"../depot_hyun/hyun/NPE_ABC/FMPE_nets/{args.task}/J_{int(args.num_training/1000)}K"
...
if __name__ == "__main__":
    ...
    for i in range(len(x0_list.tolist())):
        create_c2st_job_script(args.task, args.num_training, "c2st", i, args.seed, 10_000, "nothing", gpu_ind)
